...
namespace Engine
{
    public class Player : LivingCreature
    {
        ...
        public bool HasThisQuest(Quests quest)
        {
        ...
        public bool CompletedThisQuest(Quests quest)
        {
            foreach (PlayerQuest playerQuest in Quests)
            {
                if (playerQuest.Details.ID == quest.ID)
        ...
        public bool HasAllQuestCompletionItems(Quests quest)
        {
        ...
        public void RemoveQuestCompletionItems(Quests quest)
        {
            foreach (QuestCompletionItem qci in quest.QuestCompletionItems)
            {
                foreach (InventoryItem ii in Inventory)
        ...
        public void MarkQuestCompleted(Quests quest)
        {
        ...
        public void AddExperiencePoints(int xpGain)
        {
            ...
            MaximumHitPoints = (Level * 10); // if the player's level increased, their MaximumHitPoints will increase by 5
        }
    }
}