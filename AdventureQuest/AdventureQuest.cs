...
{
    public partial class AdventureQuest : Form
    {
        private Player _player;
        private Monster _currentMonster;

        public AdventureQuest()
        {
            InitializeComponent();
            ...
            MessageBox.Show(
            "AdventureQuest is a simple text-based rpg."
            + "\n\nYou can move by using the navigation buttons. Attack opponents to get experience by using your weapon."
            + " Every new level of your character you will gain 10 HP. Defeat the Giant Spider to the east to win the game.\n\nGood luck!", "Welcome to AdventureQuest!"); 
        }
        ...
        private void btnUseWeapon_Click_1(object sender, EventArgs e)
        {
            ...
            {
                // Check if the Monster is the Giant Spider
                if (_currentMonster.ID == 3)
                {
